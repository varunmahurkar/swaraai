...
async def create_voice_prompt_for_profile(
    ...
    # Use the first sample for voice cloning.
    # Concatenating multiple samples produces audio that is too long, causing
    # the model to emit embeddings of the wrong dimension (2048 vs expected 1024).
    sample = samples[0]
